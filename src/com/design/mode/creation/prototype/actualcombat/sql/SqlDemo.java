...
public class SqlDemo {
    ...
    private final ConcurrentHashMap<String, SearchWord> currentSearchWords = new ConcurrentHashMap<String, SearchWord>();
    ...
    public void refresh02() {
        HashMap<String, SearchWord> newKeyWords = currentSearchWords01;
